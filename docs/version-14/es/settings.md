...
- El valor predeterminado es PPD (Entrada de Pago y Depósito Preacordados)
...
![Captura de pantalla que muestra la sección Configuración de Pago Positivo. A continuación, se incluye una descripción de cada configuración y su valor predeterminado.](./assets/Settings_Positive_Pay.png)

- **Generar y adjuntar automáticamente el Pago Positivo a la Ejecución de Cheque:**
- No seleccionado por defecto
- Indica si los resultados del informe de Pago Positivo se adjuntan a la Ejecución de Cheque. El informe requiere una cuenta bancaria y las fechas de inicio y fin para filtrar los resultados. Esta función utiliza la cuenta bancaria y la fecha de contabilización de la ejecución de cheque para dichas entradas.
