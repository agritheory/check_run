context("Check Run List", () => {
  ...
  it("Add Check Run", () => {
    // TEST WORKS
    cy.get(".primary-action")
      .contains("Add Check Run")
      .should("be.visible")
      .click();
    cy.wait(1000);
    ...
    cy.get(".btn-primary")
      .contains("Start Check Run")
      .should("be.visible")
      .click();
  });

  it("Confirm Default Check Run Settings", () => {
    // TEST WORKS
    cy.wait(1000);
    ...
    cy.get_field("ach_service_class_code", "Select")
      .find("option:selected")
      .should("have.text", "200");
    cy.get_field("ach_standard_class_code", "Select")
      .find("option:selected")
      .should("have.text", "PPD");
  ...
  it("Complete First Check Run", () => {
    ...
    cy.get('[data-fieldname="amount_check_run"]')
      .get(".like-disabled-input")
      .should("contain", "$ 1,800.00");
  ...
  it("Create Check Run Settings From List", () => {
    // TEST WORKS
    ...
    cy.wait(1000);
    cy.get(".primary-action")
      .contains("Add Check Run Settings")
      .should("be.visible")
      .click();
    cy.wait(1000);
    cy.fill_field("bank_account", "Primary Checking - Local Bank")
      .blur()
      .wait(500);
    cy.fill_field("pay_to_account", "2120 - Payroll Payable - CFC")
      .blur()
      .wait(500);
    cy.get(".btn-primary").contains("Save").should("be.visible").click();
  });

  it("Complete Payroll Check Run", () => {
    // TEST WORKS
    cy.wait(3000);
    cy.go_to_list("Check Run");
    cy.get(".primary-action")
      ...
      .click();
    cy.wait(1000);
    cy.get('.modal [data-fieldname="pay_to_account"] input')
      .clear()
      .type("2120 - Payroll Payable - CFC")
      .blur();
    cy.get(".btn-primary")
      .contains("Start Check Run")
      .should("be.visible")
